...
└── Analytics Database: MongoDB 5. Luồng xử lý chính
Luồng đặt bàn
...
BASE*URL, PUBLIC_BASE_URL Cấu hình đường dẫn chạy hệ thống
DB_HOST, DB_NAME, DB_USER, DB_PASS Cấu hình kết nối MariaDB
VIETQR*_ Cấu hình thanh toán chuyển khoản bằng VietQR
MONGO\__ Cấu hình MongoDB dùng cho dữ liệu báo cáo/phân tích
