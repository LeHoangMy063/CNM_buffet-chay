...
<body class="page-admin">
    <aside class="sidebar">
        <div class="sb-logo">
            <h2><img src="<?php echo BASE_URL; ?>/public/assets/icons/pwa-icon.svg" alt="<?php echo htmlspecialchars(APP_NAME, ENT_QUOTES, 'UTF-8'); ?>"> <?php echo APP_NAME ?></h2>
        ...
        <nav>
            ...
            ?>
            <a href="<?php echo BASE_URL ?>/admin/dashboard" <?php echo (strpos($cur, 'dashboard') !== false) ? 'class="active"' : '' ?>>Dashboard</a>
            <a href="<?php echo BASE_URL ?>/admin/tables" <?php echo (strpos($cur, 'tables') !== false)    ? 'class="active"' : '' ?>>Quan ly ban</a>
            <a href="<?php echo BASE_URL ?>/admin/reservations" <?php echo (strpos($cur, 'reservations') !== false) ? 'class="active"' : '' ?>>Dat ban</a>
            <a href="<?php echo BASE_URL ?>/admin/menu" <?php echo (strpos($cur, 'menu') !== false)     ? 'class="active"' : '' ?>>Thuc don</a>
            <a href="<?php echo BASE_URL ?>/admin/orders" <?php echo (strpos($cur, 'orders') !== false)   ? 'class="active"' : '' ?>>Goi mon</a>
        </nav>
        <div class="sb-footer">
